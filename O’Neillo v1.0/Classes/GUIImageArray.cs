...
namespace GUIImageArray
{
    class GImageArray : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // GImageArray
            // 
            this.Name = "GImageArray";
            this.Load += new System.EventHandler(this.GImageArray_Load);
            this.ResumeLayout(false);

        }

        private void GImageArray_Load(object sender, EventArgs e)
        {
        ...
        {
            // Checks to see if requested element it within the boundaries
